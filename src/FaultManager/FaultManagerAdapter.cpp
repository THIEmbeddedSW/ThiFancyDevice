...
/******************************************************************************
* Name          :   fault_collect_freeze_frame_data
* Parameters     :
...
******************************************************************************/
void fault_collect_freeze_frame_data(st_fault_freeze_frame_t* pst_freeze_frame, e_fault_code_t e_fc)
{
	float local_var = 0;
...
******************************************************************************/
void fault_save(st_fault_freeze_frame_t* pst_freeze_frame)
{
